            ...
            <div class="col-md-12" style=" margin-top: 10px;background-color: ">
             ...
             <table class="table table-responsive table-bordered">
               ...
               @endforeach
                ...
                <tr><td colspan="2"><label>Cash Amount</label><input style ="text-align: right" type="text" placeholder="0.00" name="receivecash" id="receivecash" onkeypress="validate(event)" onkeydown="submitcash(event,this.value)" class="form form-control">
                        </td></tr>
                <tr><td colspan="2">
